...
class AdapterLayer (nn .Module ):
    ...
    freq_dim :int =128 ,inner_num_experts :int =2 ,
    with_complexity :bool =False ,complexity_scale :str ="min"):
        ...
        inner_num_experts =inner_num_experts 
...
class DecoderBlock (nn .Module ):
    ...
    freq_dim :int =128 ,inner_num_experts :int =2 ,with_complexity :bool =False ):
        ...
        freq_dim =freq_dim ,inner_num_experts =inner_num_experts ,
    ...
    def forward (self ,x ,freq_emb =None ):
        ...
        x_a =self .proj [1 ](x )
        x_s =self .shared (x_s )
        x_a ,loss =self .adapter (x_a ,freq_emb ,x_s )
...
class DecoderResidualGroup (nn .Module ):
    ...
    freq_dim :int =128 ,inner_num_experts :int =2 ,with_complexity :bool =False ):
        ...
        for i in range (num_blocks ):
            ...
            stage_depth =stage_depth ,freq_dim =freq_dim ,inner_num_experts =inner_num_experts ,
...
class NestedAMIFound (nn .Module ):
    ...
    complexity_scale ="max",
        ...
        for i in range (levels -1 ):
            ...
            freq_dim =dims [0 ],with_complexity =with_complexity ,inner_num_experts =inner_num_experts ,
